...
const copyPasswordToClipboard = useCallback(() => {
  ...
  passwordRef.current?.setSelectionRange(0,30)  // optimiztion - used to select a perticular range of the text from input field
...
useEffect(() => {
  ...
  return (
    <>
      <div className='w-full max-w-lg  mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-700  text-orange-700'>
